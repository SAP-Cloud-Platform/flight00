CLASS /dmo/cx_flight_legacy00 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_00',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_00',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id00 OPTIONAL
        booking_id            TYPE /dmo/booking_id00 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id00 OPTIONAL
        agency_id             TYPE /dmo/agency_id00 OPTIONAL
        customer_id           TYPE /dmo/customer_id00 OPTIONAL
        carrier_id            TYPE /dmo/carrier00-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_00-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_00-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date00 OPTIONAL
        end_date              TYPE /dmo/end_date00 OPTIONAL
        booking_date          TYPE /dmo/booking_date00 OPTIONAL
        flight_date           TYPE /dmo/flight_date00 OPTIONAL
        status                TYPE /dmo/travel_status00 OPTIONAL
        currency_code         TYPE /dmo/currency_code00 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id00,
          mv_booking_id            TYPE /dmo/booking_id00,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id00,
          mv_agency_id             TYPE /dmo/agency_id00,
          mv_customer_id           TYPE /dmo/customer_id00,
          mv_carrier_id            TYPE /dmo/carrier00-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_00-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_00-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date00,
          mv_end_date              TYPE /dmo/end_date00,
          mv_booking_date          TYPE /dmo/booking_date00,
          mv_flight_date           TYPE /dmo/flight_date00,
          mv_status                TYPE /dmo/travel_status00,
          mv_currency_code         TYPE /dmo/currency_code00,
...
CLASS /dmo/cx_flight_legacy00 IMPLEMENTATION.
