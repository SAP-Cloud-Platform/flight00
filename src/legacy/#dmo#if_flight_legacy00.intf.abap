...
INTERFACE /dmo/if_flight_legacy00
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL00
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel00     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING00
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking00    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_00
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_00 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT00
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight00 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id00.
  ...
  TYPES booking_id TYPE /dmo/booking_id00.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id00.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL00, /DMO/BOOKING00, /DMO/BOOK_SUP_00 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code00.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code00,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status00,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel00_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id00.
  INCLUDE TYPE /dmo/booking00_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id00.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id00.
  INCLUDE TYPE /dmo/book_sup_00_data.
